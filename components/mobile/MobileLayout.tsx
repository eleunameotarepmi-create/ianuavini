...
export const MobileLayout: React.FC<MobileLayoutProps> = ({
    ...
    return (
        <div className="relative flex flex-col h-full bg-stone-950 text-stone-100 overflow-hidden font-sans">
            ...
            <nav className="fixed bottom-0 w-full bg-stone-900/95 backdrop-blur-md border-t border-white/5 pb-safe-area-inset-bottom z-50 pt-2 px-2 shadow-2xl">
