...
# Resolve Dynamic IDs
id_polenta = find_dish("polent") 
id_scaloppa = find_dish("scaloppa")
id_tris = find_dish("tris")
id_formaggi = "1" # Hardcoded known ID
id_entree = "3"   # Hardcoded known ID
...
rebelle_pairings = [
    ...
    {"dishId": "4", "label": "Perfetto", "notes": "Stesso principio della fonduta, piatto ricco"}, # Uovo
...
resa_pairings = [
    ...
    {"dishId": "29", "label": "Struttura", "notes": "crosta, carne, funghi: serve struttura"}, # Wellington (Same ID usually)
...
print("Updated Brandini V3 (Fixed Entree/Carne distinction).")
